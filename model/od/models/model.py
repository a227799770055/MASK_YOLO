...
if __name__ == '__main__':
    ...
    x = torch.zeros(1, 3, 480, 480).to(device)

    model = Model(model_config='/home/insign/Doc/insign/flexible-yolov5/configs/model_morph.yaml').to(device)
    model.detection.export = True
    # model.fuse()
    import time
